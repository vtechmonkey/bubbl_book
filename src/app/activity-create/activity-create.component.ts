...
export class ActivityCreateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.localStorageForm) {
     ...
     //    }  
     // }
   //check if  there are any values in local storage
  ngDoCheck(){
  ...
  //initialise price to empty string
  initPrice() {
  ...
  onSelect(categoryName) {
    ...
    this.subCategoryService.getSubCategory(categoryName)
      .subscribe(
      subCategoryData => 
      this.subCategoryByCategory = _.filter(subCategoryData, function (o) 
      { return o.category == categoryName }, 'subCategory')
      );
  }
//submit form 
  onSubmit() {
